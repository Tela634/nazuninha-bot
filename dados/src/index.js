...
try {
 ...
 switch(command) {
  ...
  try {
    ...
    await nazu.sendMessage(from, {image: {url: `https://luabot.sirv.com/logos/ping.png?text.0.text=Velocidade%20da%20Bot&text.0.position.x=-18%25&text.0.position.y=-39%25&text.0.size=65&text.0.color=ba69ff&text.0.font.family=Nothing%20You%20Could%20Do&text.0.outline.color=ffb3fb&text.0.outline.width=6&text.0.outline.blur=23&text.1.text=${String(speedConverted.toFixed(3))}&text.1.position.x=-42%25&text.1.position.y=-20%25&text.1.size=22&text.1.color=ba69ff&text.1.font.family=Nothing%20You%20Could%20Do&text.1.outline.color=ffb3fb&text.1.outline.width=6&text.1.outline.blur=23`}, caption: `\n📡 *Status do Bot*\n-----------------------------------\n🤖 *Nome:* ${config.nomebot}\n👤 *Dono:* ${config.nomedono}\n\n📌 *Prefixo:* ${config.prefixo}\n🚀 *Latência:* ${speedConverted.toFixed(3)}s\n⏳ *Uptime:* ${uptime}`}, {quoted: info});
  } catch (e) {
    console.error(e);
